...
const ProductCard = ({ product }) => {
  ...
  return (
  <div className={"grid gap-2 rounded-xl shadow-lg bg-n1 p-4 max-h-[350px]"}>
    ...
    <div className='place-self-start flex justify-start gap-4'>
    ...
    <div className="flex flex-col gap-2 max-w-44 md:max-w-64">
