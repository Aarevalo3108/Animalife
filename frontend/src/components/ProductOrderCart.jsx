  ...
  return (
    ...
    {data &&
      <div className={"rounded-xl bg-n6 flex items-center shadow-lg gap-4 p-4"}>
        {data.images && <img className="w-36 h-36 md:h-56 md:w-56 hover:scale-125 transition duration-300 object-cover rounded-lg" src={url.backend + "/" + (data.images[0] || "uploads/placeholder.svg")} alt="" />}
