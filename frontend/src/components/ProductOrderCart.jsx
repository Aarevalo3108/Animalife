...
const ProductOrderCart = (obj) => {
  ...
  return (
    <>
    {data &&
      <div className={"rounded-xl bg-[" + colors.n6 + "] flex items-center shadow-lg gap-4 p-4"}>
        ...
        <h3 className="text-md flex flex-col max-w-32 md:max-w-96 text-ellipsis overflow-hidden">Name: <span className={"text-["+colors.n5+"] w-32 md:w-full"}>{data.name}</span></h3>
        <p className="text-sm max-w-32 md:max-w-96 h-16 flex flex-col text-ellipsis overflow-hidden md:w-96 md:h-24">Description: <span className={"text-["+colors.n5+"] w-32 md:w-full"}>{data.description}</span></p>
